                            ...
                            <div class="modal-content shadow">
                                ...
                                <div class="modal-body text-start">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox ID="txtCancelReason" runat="server" TextMode="MultiLine"
                                            CssClass="form-control" Rows="3" placeholder="Enter reason...">
                                        </asp:TextBox>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <asp:Button ID="btnConfirmCancel" runat="server" Text="Confirm Cancellation"
                                        ...
                                        OnClientClick="var btn=this; setTimeout(function(){ btn.disabled=true; btn.value='Sending...'; },10);" />
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <asp:TextBox ID="txtRescheduleReason" runat="server" TextMode="MultiLine"
                                                CssClass="form-control" Rows="2" placeholder="Optional...">
                                            </asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content shadow">
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button ID="btnConfirmDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
