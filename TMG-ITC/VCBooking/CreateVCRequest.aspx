    ...
    <form id="form1" runat="server">
        ...
        <div class="rail-viewport d-flex justify-content-center align-items-center">
            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                <ContentTemplate>
                    <div class="rail-card premium-card" style="max-width: 1120px; width: 100%;">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-8">
                                <asp:TextBox runat="server" ID="txtParticipant" CssClass="form-control form-control-premium" placeholder="Enter email address(es)..." />
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="table-responsive-premium mb-5">
                            <asp:GridView runat="server" ID="gvParticipants" CssClass="table table-premium" AutoGenerateColumns="true" GridLines="None" />
                        </div>

                        <div class="text-center">
                            <asp:Button runat="server" ID="btnFormSubmit" Text="Create VC Request" OnClick="btnFormSubmit_Click" UseSubmitBehavior="true" OnClientClick="showProcessingOverlay(); return true;" CssClass="btn-dark-navy px-5" />
                        </div>
                    </div>
                </ContentTemplate>
                <Triggers>
